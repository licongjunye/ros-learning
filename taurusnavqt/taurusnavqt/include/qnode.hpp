/**
 * @file /include/taurusnavqt/qnode.hpp
 *
...
#ifndef taurusnavqt_QNODE_HPP_
#define taurusnavqt_QNODE_HPP_
...
class QNode : public QThread {
 ...
 public slots:
  ...
  void slot_robotstatus(float,float,float);
